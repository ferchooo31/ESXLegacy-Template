...
Config.Strings = {
	...
	RefillJerryCan = "Presiona ~g~E ~w~ para llenar el bidón por ",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona ~g~E ~w~para agarrar el bidón"
	Config.Strings.RefillJerryCan = "Presiona ~g~E ~w~ para repostar el bidón"
end
...
Config.GasStations = {
	vector3(49.4187, 2778.793, 10000.043),
