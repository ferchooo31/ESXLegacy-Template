...
lib.addCommand({'additem', 'giveitem'}, {
	help = 'Da un item a un jugador',
	params = {
		{ name = 'target', type = 'playerId', help = 'El jugador al que se le dara el item' },
		{ name = 'item', type = 'string', help = 'Nombre del item' },
		{ name = 'count', type = 'number', help = 'La cantidad decuanto se va a dar', optional = true },
...
lib.addCommand('removeitem', {
	help = 'Remueve el item de un jugador',
	params = {
		{ name = 'target', type = 'playerId', help = 'Jugador al que se le quitara el item' },
		{ name = 'item', type = 'string', help = 'Nombre del item' },
		{ name = 'count', type = 'number', help = 'Cantidad que se quitara' },
...
lib.addCommand('takeinv', {
	help = 'Confisca el inventario de un jugador, para regresarle el inventario usa /restoreinv',
	params = {
		{ name = 'target', type = 'playerId', help = 'El id del jugador' },
	},
	restricted = 'group.admin',
}, function(source, args)
...
lib.addCommand({'restoreinv', 'returninv'}, {
	help = 'Regresa el inventario a un jugador',
	params = {
		{ name = 'target', type = 'playerId', help = 'Jugador al que se le regresara el inventario' },
	},
	restricted = 'group.admin',
}, function(source, args)
...
lib.addCommand('clearinv', {
	help = 'Borra el inventario de un jugador',
	params = {
		{ name = 'invId', help = 'Id del jugador' },
	},
	restricted = 'group.admin',
}, function(source, args)
