...
Config.Heli = false -- Helicopter HUD and Realisitc takeoff/landing
...
Config.StaminaBuff = false -- True to give staminia buff, allowing longer running. False to disable.
Config.VehRewards = false -- True to disable vehicle rewards (guns from cars). False to enable vehicle rewards
...
Config.lockVehicles = false -- locks AI Vehicles in traffic and/or parker ones
...
Config.DiscordRPC = {
    ["Enabled"] = true, -- Si esta habilitado se va a mostrar la presencia en discord.
    ["ApplicationId"] = '00000000000000000', -- ID de tu bot de discord
    ["IconSmall"] = 'small_logo_name', -- Nombre del icono
    ["IconSmallHoverText"] = 'This is a Small icon with text', -- Icono chico
    ["IconLarge"] = 'logo_name', -- The large icon's name
    ["IconLargeHoverText"] = 'This is a Large icon with text', -- Icono grande
    ["UpdateRate"] = 60000, -- Con que frecuencia se deberia actualizar la actividad de discord?
    ["ShowPlayerCount"] = true, -- Si está en 'true' se mostrara la cantidad de jugadores en la actividad de discord.
    ["MaxPlayers"] = 48, -- Cantidad de slots de tu servidor
    ["Buttons"] = {{
        text = 'First Button',
